          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap md:space-x-4 md:space-y-0 space-y-4">
              <button
                ...
                className="flex items-center px-4 md:w-auto mr-5 bg-[#BB86FC] text-white rounded-lg hover:bg-[#a671ed] text-sm md:text-base transition-colors"
              >
              ...
              <button
                ...
                className="flex items-center py-2 px-4 md:w-auto bg-[#BB86FC] text-white rounded-lg hover:bg-[#a671ed] text-sm md:text-base transition-colors"
              >
                <UserCircle2 className="mr-2 h-5 w-5" />
                Register Doctor
              </button>
              <Link to="/doctors-list">
                <button className="flex items-center py-2 px-4 w-full md:w-auto bg-[#BB86FC] text-white rounded-lg hover:bg-[#a671ed] text-sm md:text-base transition-colors">
                  <UserCircle2 className="mr-2 h-5 w-5" />
                  Doctors List
                </button>
              </Link>
              <button
                ...
                className="flex items-center py-2 px-4 ml-9 mr-5 md:w-auto bg-red-600 text-white rounded-lg hover:bg-red-700 text-sm md:text-base transition-colors"
              >
